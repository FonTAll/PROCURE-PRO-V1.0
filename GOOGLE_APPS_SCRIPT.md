...
Copy the code from `/backend/Code.gs` into your Google Apps Script editor (Extensions > Apps Script) in your Google Sheet. It has been updated with the Procure Pro table structures.
